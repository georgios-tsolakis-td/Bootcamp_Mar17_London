...
fl1 <- fread('On_Time_On_Time_Performance_2016_1.csv')
fl2 <- fread('On_Time_On_Time_Performance_2016_2.csv')
fl3 <- fread('On_Time_On_Time_Performance_2016_3.csv')
...
# (3) Save data to disk ####
save(fl, file = 'flightdelays1-3.RData')
write.csv(fl, file = 'flightdelays1-3.csv')
